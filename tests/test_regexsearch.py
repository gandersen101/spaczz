...
def test_regexsearch_uses_passed_config():
...
def test_regexsearch_raises_error_if_config_is_not_regexconfig():
...
def test_multi_match_will_expand_to_span_boundaries_on_partial_match_if_partials():
...
def test_multi_match_will_not_expand_partial_matches_if_not_partials():
...
def test_multi_match_will_not_find_match_if_regex_starts_or_ends_with_space():
