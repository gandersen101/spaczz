...
def test_parse_regex_with_new_regex():
...
def test_using_precompiled_regex_raises_error_when_adding_flags():
...
def test_incorrect_type_for_regex_compile_raises_error():
